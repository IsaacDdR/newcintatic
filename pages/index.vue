              ...
              >
                ...
                >
                  <span class="relative inline-block">
                    ...
                    Un sitio web moderno <br />
                    Una suscripción
                    <!--
                    <span class="relative">{{ $t('main_header.title') }}</span>
                    -->
                  </span>
                </h2>
                <p class="text-base text-indigo-100 md:text-lg">
                  <!--
                  {{ $t('main_header.description') }}
                  -->
                  Sé parte del mundo desde $189 al mes.
                </p>
              </div>
              <div>
                <a
        ...
        <div class="flex flex-col lg:flex-row">
          <div class="max-w-xl pr-16 mx-auto mb-10">
            ...
            <p class="mb-6 text-gray-900">
              Píde el sitio web que necesitas sin invertir mucho, te ofrecemos
              la solución por una pequeña suscripción mensual.
            </p>
