        ...
        >
          ...
          >
            <span class="relative inline-block">
              ...
              <span class="relative">El mejor alcance</span>
            </span>
            a tu alcance
          </h2>
          <p class="text-base text-gray-700 md:text-lg">
            No esperes más en tener la imagen y el profesionalismo que quieres
            mostrar de tu negocio, tenemos el sitio web que necesitas sin que
            gastes mucho.
          </p>
        </div>
            ...
            <div class="p-8 bg-gray-900 rounded">
              ...
              <ul class="mb-8 space-y-2">
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-300">1 página</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
                  ...
                  <p class="font-medium text-gray-300">5 secciones</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
                  ...
                  <p class="font-medium text-gray-300">SSL ilimtado</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
                  ...
                  <p class="font-medium text-gray-300">Un año de dominio</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
                ...
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-300">Links de Whatsapp</p>
                  <p></p>
                </li>
                ...
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-300">SEO</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
            ...
            <div class="p-8 bg-gray-900 rounded">
              ...
              <ul class="mb-8 space-y-2">
                <li class="flex items-center">
                  ...
                  <p class="font-medium text-gray-300">4 páginas</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
                  ...
                  <p class="font-medium text-gray-300">20 secciones</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
                  ...
                  <p class="font-medium text-gray-300">SSL ilimitado</p>
                </li>
                <li class="flex items-center">
                  <div class="mr-3">
                    <svg
      ...
      <div class="container px-5 py-24 mx-auto">
        ...
        >
          <h1
            ...
            "
          >
            Somos muy flexibles, si no está lo que encuentras avísanos y con
